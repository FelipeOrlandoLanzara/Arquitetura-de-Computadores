...
adicionar:;Incrementa o pedido selecionado
	...
	ACALL clra
	RET
;pedidos - incrementa no endereço de cada pedido a quantidade (1) quando o produto é selecionado
	cocacola:
		SETB F0
		INC 7EH
		ACALL pedido_adc
...
print_ponteiro: ; serve para printar no display o ponteiro
	ACALL clearDisplay
	ACALL posicionaCursor
...
pedido_adc:;Mostra no display "Pedido adicionado"
	ACALL clearDisplay
 	MOV A, #04h
  	ACALL posicionaCursor
  	MOV DPTR,#DISPLAY11            ;endereço inicial de memória da String FEI
  	ACALL escreveStringROM
  	MOV A, #43h
  	ACALL posicionaCursor
